...
#         Delimiter='/'
#     )
#     child_directory_name = response.get('CommonPrefixes')[0].get('Prefix').split('/')[-2]
...
def initialize_plot(device_id, i):
    ...
    if show_plot:
        ...
        y_slider = plt.Slider(y_slider_ax, 'y', slider_min, slider_max, valinit=y_trans, valstep=1,
